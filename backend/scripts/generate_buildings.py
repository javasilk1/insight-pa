...
def main():
    ...
    with open(OUTPUT_SQL, "w", encoding="utf-8") as sql_file:
        ...
        sql_file.write("INSERT INTO buildings (id, address, coordinates, cadastral_data, quartu_frazione, risk_score, status) VALUES\n")
        ...
        for b in buildings:
            ...
            values.append(
                ...
                f"'{cadastral_json_escaped}'::jsonb, '{b['quartu_frazione']}', {b['risk_score']}, '{b['status']}')"
            )
